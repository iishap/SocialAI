...
import { Linkedin, Settings, BarChart3, Image, Calendar } from "lucide-react"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Manage your LinkedIn content and analytics</p>
            </div>
          </div>
          ...
          <TabsContent value="analytics" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance metrics for your LinkedIn account</CardDescription>
              </CardHeader>
              <CardContent className="h-[300px] flex items-center justify-center">
                <div className="flex flex-col items-center text-center">
                  <BarChart3 className="h-16 w-16 text-muted-foreground/50" />
                  <h3 className="mt-4 text-lg font-medium">Connect LinkedIn to view insights</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Connect your LinkedIn account to view detailed analytics and insights
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
              <Card className="col-span-1 md:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>Optimize your LinkedIn content strategy</CardDescription>
                </CardHeader>
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Tuesday, Wednesday, and Thursday between 8-10 AM
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Posts with data and statistics get 37% more engagement
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 space-y-4">
                    <Button className="w-full">Schedule LinkedIn Post</Button>
